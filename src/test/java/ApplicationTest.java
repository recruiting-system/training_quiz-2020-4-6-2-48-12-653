...
class ApplicationTest {
  ...
  void should_throw_exception_with_message_when_park_given_init_and_car_and_general_boy() {
    ...
    ParkingLotFullException fullException = assertThrows(ParkingLotFullException.class, () -> Application.park("H12626"));
    assertEquals("停车场已没有空位，暂时无法停车", fullException.getMessage());
  }
  ...
  void should_throw_exception_with_message_when_fetch_given_ticket_information_is_not_correct() {
    ...
    InvalidTicketException invalidParkingLotId = assertThrows(InvalidTicketException.class, () -> Application.fetch("C,1,A12098"));
    assertEquals("停车券无效", invalidParkingLotId.getMessage());
    InvalidTicketException invalidParkingSpaceId = assertThrows(InvalidTicketException.class, () -> Application.fetch("A,9,A12098"), "停车券无效");
    assertEquals("停车券无效", invalidParkingSpaceId.getMessage());
    InvalidTicketException invalidSpaceId = assertThrows(InvalidTicketException.class, () -> Application.fetch("B,-1,A12098"), "停车券无效");
    assertEquals("停车券无效", invalidSpaceId.getMessage());
  }
  ...
  void should_throw_exception_with_message_when_fetch_given_spacee_has_no_car() {
    ...
    InvalidTicketException invalidTicketException = assertThrows(InvalidTicketException.class, () -> Application.fetch(aTicket));
    assertEquals("停车券无效", invalidTicketException.getMessage());
  }
